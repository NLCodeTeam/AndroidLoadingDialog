...
public class Util {
    ...
    public static final String PASSWORD_CHARACTERS_PATTERN = "^[a-zA-Z0-9:;|`~?!@.#$%^&*+-=_]+$";

    public static final int MIN_LOGIN_LENGTH = 6;
    public static final int MAX_LOGIN_LENGTH = 20;

    public static final int ERROR_ACTION_WARNING = 0;
    public static final int ERROR_ACTION_EXIT = 1;
    public static final int ERROR_ACTION_WARNING_EXIT = 2;
